        ...
        <div className="row">
          ...
          <div className="about-text-box">
            ...
            <p className="about-text">
              ...
              strong foundation in design principles, I strive to bridge the gap
              between aesthetics and functionality. My goal is to craft digital
              solutions that make a lasting impact. When I am not coding, you
              can find me exploring new design trends, contributing to
              open-source projects, or enjoying a good cup of coffee while
              brainstorming my next creative endeavor.
            </p>
